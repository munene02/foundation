...
<head>
    ...
    <meta charset="utf-8">
    <title>Get in Touch | The Impact Foundation </title>
...
<body class="template-slider  color-custom style-default layout-full-width nice-scroll-on mobile-tb-left button-flat no-content-padding minimalist-header-no sticky-header sticky-white ab-hide subheader-title-left menuo-no-borders tr-content header-plain">
                                    ...
                                    <div class="mcb-wrap-inner">
                                        <div class="column mcb-column one column_map ">
                                            ...
                                            <div class="google-map-wrapper no_border">
                                                <div class="google-map" id="google-map-area-56b4be027c3b6" style="width:100%; height:500px;">
                                                    &nbsp;
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="column mcb-column two-third column_column">
                                            <div class="column_attr">
                                                ...
                                                <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                    <div class="image_wrapper"><img class="scale-with-grid" src="images/home_charity2_sep4.png" alt="" width="148" height="20" />
                                                    </div>
                                                </div>
                                        ...
                                        <div class="column mcb-column one-third column_placeholder">
                                            <div class="column mcb-column one column_column">
                                                <div class="column_attr">
                                                    ...
                                                    <div class="image_frame image_item no_link scale-with-grid alignnone no_border">
                                                        <div class="image_wrapper"><img class="scale-with-grid" src="images/home_charity2_sep3.png" alt="" width="148" height="20" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="column_attr">
                                                <p  class="big">
                                                    <strong style="color:#2ab574;">Email:</strong> <br/> <a href="mailto:info@theimpactfoundation.com">info@theimpactfoundation.co.ke</a>
                                                </p>
                                                <p class="big">
                                                    <strong style="color:#2ab574;">Address: <br/> </strong> P. O. Box 3977-00200, Nairobi, Kenya
                                                </p>
                                                <p class="big">
                                                    <strong style="color:#2ab574;">Mobile: <br/> </strong> +254 733 585 334
                                                </p>
                                                <p class="big">
                                                    <strong style="color:#2ab574;">Location: <br/> </strong> Kc Arora Complex, Mombasa Road.
                                                </p>
    ...
    <script>
        function google_maps_56b4be027c3b6() {
            ...
            var map = new google.maps.Map(document.getElementById("google-map-area-56b4be027c3b6"), myOptions);
            var marker = new google.maps.Marker({
                position: latlng,
                icon: "images/home_charity2_pin_small.png",
                map: map
            });
        }
        jQuery(document).ready(function($) {
            google_maps_56b4be027c3b6();
        });
    </script>
